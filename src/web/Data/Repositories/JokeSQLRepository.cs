...
public class JokeSQLRepository(DadABaseDbContext context) : IJokeRepository
{
    ...
    public bool UpdateImageTxt(int jokeId, string imageTxt, string requestingUserName = "ANON")
    {
        ...
        {
            Console.WriteLine($"Error updating ImageTxt for JokeId {jokeId}: {Utilities.GetExceptionMessage(ex)}");
            return false;
        }
    }
    ...
    public bool UpdateJoke(Joke joke, string requestingUserName = "ANON")
    {
        ...
        {
            Console.WriteLine($"Error updating joke {joke.JokeId}: {Utilities.GetExceptionMessage(ex)}");
            return false;
        }
    }
    ...
    public bool UpdateJokeCategories(int jokeId, List<int> categoryIds, string requestingUserName = "ANON")
    {
        try
        {
            ...
            _context.SaveChanges();
                    ...
                    {
                        Console.WriteLine($"Error updating categories for joke {jokeId}: {Utilities.GetExceptionMessage(ex)}");
                        return false;
                    }
                }
    ...
    public int AddJoke(Joke joke, string requestingUserName = "ANON")
    {
        ...
        {
            Console.WriteLine($"Error adding joke: {Utilities.GetExceptionMessage(ex)}");
            return -1;
        }
    }
