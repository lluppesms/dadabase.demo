...
This repository is an example of deploying a .NET 10 web app into an Azure Web App. The app itself is a very simple website (with APIs) that just reads a SQL database (or a JSON file!) and returns a random dad joke, along with a few other APIs like search and category list.
